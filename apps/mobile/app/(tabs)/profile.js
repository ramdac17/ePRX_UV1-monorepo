...
import { StyleSheet, View, Text, TouchableOpacity, Image, Alert, ScrollView, ActivityIndicator, // Added for feedback
 } from "react-native";
...
export default function ProfileScreen() {
    ...
    return (<ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.avatarSection}>
        <TouchableOpacity onPress={pickImage} style={styles.avatarWrapper} disabled={uploading} // Prevent double uploads
    >
          {user?.image ? (<Image source={{
                uri: `${BASE_IMAGE_URL}${user.image}?t=${new Date().getTime()}`,
            }} // Cache busting
         style={styles.avatar}/>) : (<View style={styles.placeholder}>
      ...
      <View style={styles.menuSection}>
        <TouchableOpacity style={styles.menuItem} onPress={() => Alert.alert("RESET", "PASSWORD_RESET_PROTOCOL_INITIATED")}>
