...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            alert(`REGISTRATION_FAILED: ${Array.isArray(serverMessage) ? serverMessage[0] : serverMessage}`);
        }
        finally {
            setIsLoading(false);
        }
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} bounces={false}>
        <View style={styles.background}>
          ...
          <View style={styles.glassCard}>
            ...
            <TextInput style={styles.input} placeholder="CYBER_PUNK_01" placeholderTextColor="#444" value={username} onChangeText={setusername} autoCapitalize="none"/>
            ...
            <TextInput style={styles.input} placeholder="USER@SYSTEM.IO" placeholderTextColor="#444" value={email} onChangeText={setEmail} autoCapitalize="none" keyboardType="email-address"/>

            <Text style={styles.label}>MOBILE_NODE</Text>
            <TextInput style={styles.input} placeholder="+63 9XX XXX XXXX" placeholderTextColor="#444" value={mobile} onChangeText={setmobile} keyboardType="phone-pad"/>
            ...
            <Pressable onPress={handleRegister} disabled={isLoading} style={[styles.button, isLoading && { opacity: 0.5 }]}>
